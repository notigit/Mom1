...
package com.xiaoaitouch.mom.zxing.camera;
...
//      }
  ...
  public Camera openDriver(SurfaceHolder holder , Point point) throws IOException {
    if (camera == null) {
      camera = Camera.open();
      if (camera == null) {
        throw new IOException();
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
  ...
  * 闪光灯
  * */
  public void setFlashMode(boolean isOpen){
