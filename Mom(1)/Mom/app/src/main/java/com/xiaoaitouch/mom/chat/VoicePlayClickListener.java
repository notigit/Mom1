 ...
 */
package com.xiaoaitouch.mom.chat;
...
public class VoicePlayClickListener implements View.OnClickListener {
    ...
    private boolean isOpenSpeaker = false;            //是否打开扬声器
    ...
    public void stopPlayVoice() {
        ...
        isPlaying = false;
        ((EasemobActivity) activity).playMsgId = null;
    ...
    public void playVoice(String filePath) {
        ...
        ((EasemobActivity) activity).playMsgId = message.getMsgId();
    ...
    public void onClick(View v) {
        ...
        if (isPlaying) {
            if (((EasemobActivity) activity).playMsgId != null && ((EasemobActivity) activity).playMsgId.equals(message.getMsgId())) {
