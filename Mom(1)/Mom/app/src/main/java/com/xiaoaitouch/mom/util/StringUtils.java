...
public class StringUtils {
    ...
    public static String getCurrentTimeSs() {
        ...
        return now.get(Calendar.YEAR) + "-"
                + getDataValues(now.get(Calendar.MONTH) + 1) + "-"
                + getDataValues(now.get(Calendar.DATE));
    }
    ...
    public static long getDateFromStrss(String time) {
    ...
    public static int getIntervalTime(String startTime, String lastStartDate) {
        long timeValue = getDateFromStrss(startTime) - getDateFromStrss(lastStartDate);
        return (int) (timeValue / 1000);
    }
    ...
    public static String getScannerMac(String macAddress) {
        try {
            String m_1 = macAddress.substring(0, 2);
            String m_2 = macAddress.substring(2, 4);
            String m_3 = macAddress.substring(4, 6);
            String m_4 = macAddress.substring(6, 8);
            String m_5 = macAddress.substring(8, 10);
            String m_6 = macAddress.substring(10, 12);

            String mac = m_1 + ":" + m_2 + ":" + m_3 + ":" + m_4 + ":" + m_5
                    + ":" + m_6;
            return mac;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static Long getEndTime() {
        ...
        todayEnd.set(Calendar.SECOND, 53);
