...
public class MipcaActivityCapture extends BaseActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnFlash = (Button) findViewById(R.id.capture_flash);
        btnFlash.setTag(false);
        btnFlash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                boolean isFlash = (Boolean) btnFlash.getTag();

                CameraManager.get().setFlashMode(!isFlash);
                btnFlash.setTag(!isFlash);
                btnFlash.setSelected(!isFlash);
            }
        });
    }
