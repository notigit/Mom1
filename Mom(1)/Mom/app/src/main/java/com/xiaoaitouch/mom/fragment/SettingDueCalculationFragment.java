 ...
 * @version: V1.0
 */
public class SettingDueCalculationFragment extends BaseFragment {
    @Bind(R.id.setting_due_calculation_menstruation_tv)
    TextView settingDueCalculationMenstruationTv;
    @Bind(R.id.setting_due_calculation_menstruation_cycle_tv)
    TextView settingDueCalculationMenstruationCycleTv;
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        View view = inflater.inflate(R.layout.setting_due_calculation_fragment, container, false);
    ...
    protected void initViewData() {
        ...
        if (userModule != null) {
            if (!TextUtils.isEmpty(userModule.getLastMensesTime())
                ...
                settingDueCalculationMenstruationTv.setText(mEndDueTime);
                ...
                String dueTime = StringUtils.getAddDate(mDueTimes, -280);
                settingDueCalculationMenstruationTv.setText(dueTime);
            }
            settingDueCalculationMenstruationCycleTv.setText(userModule.getMensesCircle() + "天");
        }
    ...
    @OnClick(R.id.setting_due_calculation_menstruation_tv)
    public void userInputDue() {
        showDateDialog("末次月经日期", true);
    }

    @OnClick(R.id.setting_due_calculation_menstruation_cycle_tv)
    public void userMenstruationCycle() {
        final int cycle = 12;
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.update_menstrual_cycle_item, null);
        final ButtomDialog buttomDialog = new ButtomDialog(getActivity());
        final AbstractWheel mCycleAbstractWheel = (AbstractWheel) view
        ...
        mCompleteTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int mCycle = mCycleAbstractWheel.getCurrentItem() + cycle;
                settingDueCalculationMenstruationCycleTv.setText(mCycle + "天");
                buttomDialog.cancel();
            }
        });
        setAbstractWheelData(12, 30, 6, mCycleAbstractWheel);
    ...
    private void setAbstractWheelData(int initValue, int forValue,
                                      int currentIndex, final AbstractWheel abstractWheel) {
    ...
    public void saveDue() {
        ...
        String mDueDayStr = settingDueCalculationMenstruationCycleTv.getText().toString().trim();
