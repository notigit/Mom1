...
public class RoundedImageView extends ImageView {
    ...
    private void boundSpringTouchLisener() {
        // this.setOnTouchListener(new ViewSpringTouchListener(this));
    }
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ((RoundedDrawable) drawable).setScaleType(mScaleType).setCornerRadius(mCornerRadius)
                    .setBorderWidth(mBorderWidth).setBorderColors(mBorderColor).setOval(mOval);
