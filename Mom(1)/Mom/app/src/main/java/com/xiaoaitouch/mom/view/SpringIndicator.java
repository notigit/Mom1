        ...
        viewPager.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if (position + 1 < tabContainer.getChildCount()) {
                    ViewGroup.LayoutParams layoutParams = tabContainer.getChildAt(position + 1).getLayoutParams();
                    layoutParams.width = (int) (positionOffset * 32 + 32);
                    tabContainer.getChildAt(position + 1).setLayoutParams(layoutParams);
                }

                ViewGroup.LayoutParams layoutParams2 = tabContainer.getChildAt(position).getLayoutParams();
                layoutParams2.width = (int) ((1 - positionOffset) * 32 + 32);
                tabContainer.getChildAt(position).setLayoutParams(layoutParams2);
