...
public class WheelHorizontalView extends AbstractWheelView {
    ...
    public void setSelectorPaintCoeff(float coeff) {
        ...
        if (mVisibleItems == 2) {
            ...
            int[] colors = {
                    c2, c1, 0xff000000, 0xff000000, c1, c2
            };
            float[] positions = {
                    0, p1, p1, p2, p2, 1
            };
            ...
            int[] colors = {
                    c2, c2, c2, c2, 0xff000000, 0xff000000, c2, c2, c2, c2
            };
            float[] positions = {
                    0, p3, p3, p1, p1, p2, p2, p4, p4, 1
            };
            shader = new LinearGradient(0, 0, w, 0, colors, positions, Shader.TileMode.CLAMP);
        }
    ...
    protected void onScrollTouchedUp() {
        ...
        View itm;
        Log.e(LOG_TAG,
                " ----- layout: " + mItemsLayout.getMeasuredWidth()
                        + mItemsLayout.getMeasuredHeight());
    ...
    protected void measureLayout() {
        ...
        mItemsLayout.measure(
                MeasureSpec.makeMeasureSpec(getWidth() + getItemDimension(),
