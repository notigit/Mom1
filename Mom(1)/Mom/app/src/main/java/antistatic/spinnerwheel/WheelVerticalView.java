...
public class WheelVerticalView extends AbstractWheelView {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mSelectionDividerHeight = a.getDimensionPixelSize(R.styleable.WheelVerticalView_selectionDividerHeight,
    ...
    protected void measureLayout() {
        ...
        mItemsLayout.measure(MeasureSpec.makeMeasureSpec(getWidth() - 2 * mItemsPadding, MeasureSpec.EXACTLY),
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            height = Math.max(getItemDimension() * (mVisibleItems - mItemOffsetPercent / 100),
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        mItemsLayout.measure(MeasureSpec.makeMeasureSpec(width - 2 * mItemsPadding, MeasureSpec.EXACTLY),
                MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
